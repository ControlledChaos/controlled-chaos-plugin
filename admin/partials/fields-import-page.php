...
namespace CCPlugin\Fields_Import_Page;
...
<div class="wrap import-registered-field-groups">
    <h1><?php esc_html_e( 'Registered Fields', 'controlled-chaos' ); ?></h1>
    <p class="description"><?php esc_html_e( 'Tools for ACF fields registered by the Controlled Chaos plugin.', 'controlled-chaos' ); ?></p>
    <h2 class="nav-tab-wrapper">
        <a href="edit.php?post_type=acf-field-group&page=acf-theme-fields&tab=ccp-registered-fields-import" class="nav-tab <?php echo $active_tab == 'ccp-registered-fields-import' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Import', 'controlled-chaos' ); ?></a>
        <a href="edit.php?post_type=acf-field-group&page=acf-theme-fields&tab=ccp-registered-fields-activation" class="nav-tab <?php echo $active_tab == 'ccp-registered-fields-activation' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Activation', 'controlled-chaos' ); ?></a>
    </h2>
    <?php if ( $active_tab == 'ccp-registered-fields-import' ) :
        ...
        <div class="notice notice-warning is-dismissible below-h2">
            ...
            <p><?php printf( '<p>%1s<a href="%2s">%3s</a>%4s</p>', admin_url( '/edit.php?post_type=acf-field-group&page=acf-theme-fields&tab=ccp-registered-fields-activation' ), esc_html__( 'Disable', 'controlled-chaos' ), esc_html__( ' the imported field groups. The duplicate field IDs will interfere with the editing of fields.', 'controlled-chaos' ) ); ?>
        </div>
        <?php }
